...
export default function CheckoutPage() {
    ...
    const handleNext = async (data: FieldValues) => {
        // qitu bohet order submission pra e mer order number e bon set e clear basket , api e fshin cookie vet e nese nuk jem n hapin e dyt veq bohet +1
                    ...
                    {activeStep === steps.length ? (
                        <>
                            ...
                            {paymentSucceeded ? (
                                 ...
                                 shipped as this is a testing phase on our 'fake' store!
                             </Typography>
                            ): (
