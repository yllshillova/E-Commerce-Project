...
namespace API.Controllers
{
    public class ProductsController : BaseApiController
    {
        ...
        [HttpGet("{id}", Name = "GetProduct")] // ky eshte kerkesa per me marr vetem nje produkt te caktuar {id} eshte id-ja e produktit qe do t jepet ex api/products/3
        ...
        {
            // te map nkto <> deri ku po shkojm edhe nkllapa tani prej ku po dojm me map
